  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li <?php if(@$_GET['q']==6) echo'class="active"'; ?>><a href="headdash.php?q=6">Defaulter</a></li>
...
<?php if(@$_GET['q']== 6) 
{
$q=mysqli_query($con,"SELECT * FROM defaulter  ORDER BY name DESC " )or die('Error223');
echo  '<div class="panel title">
<table class="table table-striped title1" >
<tr ><td><b>Name</b></td><td><b>Test</b></td><td><b>Tab Changed</b></td><td><b>Other User</b></td><td><b>Disorientatiion</b></td><td><b>Other Person</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
...
$tab_changed=$row['tab_changed'];
$other_user=$row['other_user'];
$disorientation=$row['disorientation'];
$other_person=$row['other_person'];

echo '<tr><td style="color:#99cc32"><b>'.$name.'</b></td><td>'.$test_name.'</td><td>'.$tab_changed.'</td><td>'.$other_user.'</td><td>'.$disorientation.'</td><td>'.$other_person.'</td><td>';
}
echo '</table></div>';}
