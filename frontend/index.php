...
.clear{
  ...
  .jumbotron {
    ...
    /* background-color: #a1045a;*/
     background-image: linear-gradient(to right top, #742250, #7e1362, #83007a, #7f0096, #6f0db6, #5e3fd2, #425deb, #0078ff, #00a1ff, #00c1fa, #74dbee, #c4f1ee);
      color: #fff;
      padding: 100px 25px;
...
<div style=" height:700px; background-image: url(assets/bg6.jpg); background-repeat: no-repeat; background-size: cover; align-content:center"  >
<div class=" text-center"  >
  <h1 style="font-size: 5em; color:white; padding-top: 6em">ONLINE REMOTE EXAMINATION</h1> 
  <p  style="font-size: 2em; color:white; padding-top: 0.5em">WITH FULL SURVEILLANCE</p> 
</div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span style="color: #512D8B;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -ADMIN</b></span></h4>
      </div>
...
<div class="modal fade" id="login2">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color: #512D8B !important;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -TEACHER</b></span></h4>
      </div>
      <div class="modal-body title1">
<div class="row">
<div class="col-md-3"></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color: #512D8B !important;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -USER</b></span></h4>
      </div>
...
<div class="modal fade" id="myModal1">
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        <button type="button" style="background-color: #512D8B !important;"class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title title1"><span  style="color: #512D8B !important;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>SIGN UP</b></span></h4>
      </div>
      <div class="modal-body">
...
<div class="form-group">
  ...
  <div class="col-md-6"> 
    <input  type="submit"  style="background: #512D8B !important;" class="sub" value="sign up"  />
  </div>
</div>
</fieldset>
</form>
...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    ...
    <div class="thumbnail">
        ...
        <p><strong>AYUSH MAHESHWARI</strong></p>
      </div>
        
     <div class="thumbnail">
        
        <p><strong>HIMANSHU JAIN</strong></p>
      </div>

      <div class="thumbnail">
        
        <p><strong>SAKSHI GUPTA</strong></p>
      </div>
    
    <!--<div class="col-sm-4">-->
      <div class="thumbnail">
        
        <p><strong>SHREY GUPTA</strong></p>
      </div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-phone"></span> +91 9039526495 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> sakshigupta10a@gmail.com</p>
    </div>
