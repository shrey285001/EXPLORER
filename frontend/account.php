...
<link  rel="stylesheet" href="css/bootstrap.min.css"/>
 ...
 <script defer type="text/javascript" src="js/webcam.js"></script>
...
<video  id="webcam"  autoplay playsinline width="400" style="position:absolute; opacity: 0 ;height=480;"></video>
<div id = "webcam-div" style = "display: flex; justify-content: center; align-items: center;height:350px; flex-direction: column">
<canvas id="canvas" class="d-none"></canvas></div>
<script>
  if (document.URL !== "http://localhost/Online-exam-system/account.php?q=1" ){
    document.getElementById("webcam-div").setAttribute("style", "display:none");
  }
  //API CALL 
  fetch(".api/http://65.0.134.102:8080/").then(
    console.log("Verified")
  ).catch(err => console.log("Not verified"))
</script>
<audio id="snapSound" preload = "auto" ></audio>
<img id="download-photo" style="width: 200px;height: 200px; display: none;"></img>
<div id="cameraFlip"></div>
<div id="user">
<div class="header">
<div class="row" style="background-color:rgba(0, 0, 0, 0.507);">
<div class="col-lg-6" >
